...
//                            CoreDataManager.shared.saveWeatherData(temperature: decodedObj.currentTempurature, humidity: decodedObj.currentWind, feelslike: decodedObj.currentFeelsLike)
